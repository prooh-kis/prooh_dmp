          ...
          <div className="grid grid-cols-6">
            <div className="col-span-3 border-r border-gray-300 p-2">
              <div className="flex items-center gap-2 p-4">
                <div className="w-[50px] h-[50px] rounded-[8px] border border-[#D7D7D730]">
                  <img className="rounded-[8px]" src={heroDetails?.avatar} alt={heroDetails?.name} />
                </div>
                <div className="">
                  <h1 className="text-[20px] font-semibold">{heroDetails?.name.toUpperCase()}</h1>
                  <p className="text-[14px] text-gray-500 font-medium">{heroDetails?.role}</p>
                </div>
              </div>
              <div className="p-4">
                ...
                <div className="grid grid-cols-6 flex items-center border-b border-gray-300 p-2">
                  <div className="col-span-3 flex items-center gap-2">
                    <div className="rounded-full bg-[#3A9868] p-2">
                      <i className="fi fi-br-user text-[14px] text-white flex items-center justify-center"></i>
                    </div>
